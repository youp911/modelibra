 ...
 * the License.
 */
package education.wicket.library.bookitem;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1235857282292L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		BookItems bookItems = (BookItems) viewModel.getEntities();
		// bookItems = bookItems.getBookItemsOrderedBy????(true);
		newViewModel.setEntities(bookItems);
		return newViewModel;
	}
