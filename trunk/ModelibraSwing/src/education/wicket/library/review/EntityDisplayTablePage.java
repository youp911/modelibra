 ...
 * the License.
 */
package education.wicket.library.review;
...
public class EntityDisplayTablePage extends
	...
	private static final long serialVersionUID = 1235857133376L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Reviews reviews = (Reviews) viewModel.getEntities();
		// reviews = reviews.getReviewsOrderedBy????(true);
		newViewModel.setEntities(reviews);
		return newViewModel;
	}
