 ...
 * the License.
 */
package education.wicket.library.author;
...
public class EntityDisplayTablePage extends
	...
	private static final long serialVersionUID = 1235856477622L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Authors authors = (Authors) viewModel.getEntities();
		// authors = authors.getAuthorsOrderedBy????(true);
		newViewModel.setEntities(authors);
		return newViewModel;
	}
