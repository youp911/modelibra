...
import universite.UniversiteConfig;
import universite.PersistentUniversite;
...
public class Start {
	...
	public Start() {
		...
		Universite universite = new Universite(domainConfig);
		new PersistentUniversite(universite);
		...
		App app = new App(universite, natLang);
