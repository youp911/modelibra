 ...
 * the License.
 */
package education.wicket.library.writer;
...
public class EntityUpdateTablePage extends
	...
	private static final long serialVersionUID = 1235856417419L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Writers writers = (Writers) viewModel.getEntities();
		// writers = writers.getWritersOrderedBy????(true);
		newViewModel.setEntities(writers);
		return newViewModel;
	}
