 ...
 * the License.
 */
package education.wicket.library.book;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1234736431789L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		Books books = (Books) viewModel.getEntities();
		// books = books.getBooksOrderedBy????(true);
		newViewModel.setEntities(books);
		return newViewModel;
	}
