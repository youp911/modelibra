...
import proto.Proto;
import proto.ProtoConfig;
import proto.PersistentProto;
...
public class Start {
	...
	public Start() {
		...
		Proto proto = new Proto(domainConfig);
		new PersistentProto(proto);
