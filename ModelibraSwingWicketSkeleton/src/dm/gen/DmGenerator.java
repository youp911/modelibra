...
public class DmGenerator {
	...
	public static final String DOMAIN_CODE = "DomainCodeAsInConfiguration";
	...
	public DmGenerator() {
		...
		dmModelibraSwingGenerator = new DmModelibraSwingGenerator(domainConfig,
				sourceDirectoryPath, true);

		dmModelibraWicketGenerator = new DmModelibraWicketGenerator(
				domainConfig, authors, sourceDirectoryPath, true);
	}
