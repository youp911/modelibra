 ...
 * the License.
 */
package modelibra.wicket.designer.metamodel;
...
public class EntityUpdateTablePage extends
	...
	private static final long serialVersionUID = 1208025838303L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		try {
			MetaModels metaModels = (MetaModels) viewModel.getEntities();
			// metaModels = metaModels.getMetaModelsOrderedBy????(true);
			newViewModel.setEntities(metaModels);
		} catch (Exception e) {
