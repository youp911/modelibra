 ...
 * the License.
 */
package modelibra.wicket.designer.metatype;
...
public class EntityDisplayListPage extends
	...
	private static final long serialVersionUID = 1211139625812L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		try {
			MetaTypes metaTypes = (MetaTypes) viewModel.getEntities();
			// metaTypes = metaTypes.getMetaTypesOrderedBy????(true);
			newViewModel.setEntities(metaTypes);
		} catch (Exception e) {
