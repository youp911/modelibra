 ...
 * the License.
 */
package modelibra.wicket.designer.metadomain;
...
public class EntityDisplaySlidePage extends
	...
	private static final long serialVersionUID = 1208025829110L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		try {
			MetaDomains metaDomains = (MetaDomains) viewModel.getEntities();
			// metaDomains = metaDomains.getMetaDomainsOrderedBy????(true);
			newViewModel.setEntities(metaDomains);
		} catch (Exception e) {
