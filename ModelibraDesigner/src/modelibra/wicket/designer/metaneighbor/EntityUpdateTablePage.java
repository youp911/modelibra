 ...
 * the License.
 */
package modelibra.wicket.designer.metaneighbor;
...
public class EntityUpdateTablePage extends
	...
	private static final long serialVersionUID = 1211983552931L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		try {
			MetaNeighbors metaNeighbors = (MetaNeighbors) viewModel.getEntities();
			// metaNeighbors = metaNeighbors.getMetaNeighborsOrderedBy????(true);
			newViewModel.setEntities(metaNeighbors);
		} catch (Exception e) {
