 ...
 * the License.
 */
package game.wicket.rushhour.area;
...
public class EntityUpdateTablePage extends
	...
	private static final long serialVersionUID = 1174415701632L;
	...
	private static ViewModel getNewViewModel(final ViewModel viewModel) {
		...
		try {
			Areas areas = (Areas) viewModel.getEntities();
			// areas = areas.getAreasOrderedBy????(true);
			newViewModel.setEntities(areas);
		} catch (Exception e) {
